...
const Page = ({ story, preview }: PageProps) => {
  if (preview) {
  ...
  if (!story?.content) {
    return (
      <div className="container w-screen h-screen p-4 flex justify-center items-center">
        Lade...
      </div>
    )
  }
...
export async function getStaticProps({ params, preview = false }: GetStaticProps) {
